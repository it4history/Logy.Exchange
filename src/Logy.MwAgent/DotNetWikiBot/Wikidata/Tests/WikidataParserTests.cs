      ...
      ""claims"": {
        ""P625"": [
          ...
          },
          {
            ...
            var result = WikidataParser.ParseWikidataItem(json);
            Assert.AreEqual(47.638791, result.Claims.Coor.Y);
            Assert.AreEqual(47.33, result.Claims.CoorRiverSource.Y);
            Assert.AreEqual(47.6308, result.Claims.CoorRiverMouth.Y);
        }
    }
}
